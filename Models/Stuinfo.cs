...
namespace Stusign.Models
{
    public partial class Stuinfo
    {
        ...
        public string 学生组别 { get; set; }
        public DateTime? 门检时间 { get; set; }
        public string 审核位置 { get; set; }
        public string 审核人员 { get; set; }
        public string 考场编号 { get; set; }
        public string 活动位置 { get; set; }
        public string 入围方式 { get; set; }
        public bool? 审核结果 { get; set; }
        public bool? 卡片打印 { get; set; }
        public string 打印人员 { get; set; }
        public DateTime? 打印时间 { get; set; }
        public bool? 开放状态 { get; set; }
        public short 查询次数 { get; set; }
    }
}
